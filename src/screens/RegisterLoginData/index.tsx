...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    try{
      const savedPasswords: FormData[] = await AsyncStorage.getItem(dataKey)
        .then((response) => response ? JSON.parse(response) : [] as FormData[]);
      const data = JSON.stringify([...savedPasswords, newLoginData]);
